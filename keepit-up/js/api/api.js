...
export function storeProfileImageUrlToServer(imageUrl, userId) {
    return fetchAPIWithBody(`${API_BASE}/api/images/signUp/profiles`, 'POST', JSON.stringify({ imageUrl, userId }));
}
...
export function storePostImageUrlToServer(imageUrl, postId) {
    return fetchAPIWithBody(`${API_BASE}/api/images/posts/${postId}`, 'POST', JSON.stringify({ imageUrl }));
}
...
export function updatePostImageUrl(imageUrl, postId) {
    return fetchAPIWithBody(`${API_BASE}/api/images/posts/${postId}`, 'PUT', JSON.stringify({ imageUrl }));
}
...
export function updateUserProfileImageUrl(imageUrl, userId) {
    return fetchAPIWithBody(`${API_BASE}/api/images/profiles`, 'PUT', JSON.stringify({ imageUrl, userId }));
}
